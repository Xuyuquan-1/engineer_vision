...
#include "camera_interface/msg/detail/port__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = camera_interface::msg::Port;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const camera_interface::msg::Port *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<camera_interface::msg::Port *>(
    untyped_ros_message);
...
{
  return &camera_interface::msg::typesupport_fastrtps_cpp::_Port__handle;
}
