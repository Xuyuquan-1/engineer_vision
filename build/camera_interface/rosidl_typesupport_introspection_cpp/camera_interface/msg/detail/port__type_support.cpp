...
{
  new (message_memory) camera_interface::msg::Port(_init);
}

void Port_fini_function(void * message_memory)
{
  auto typed_message = static_cast<camera_interface::msg::Port *>(message_memory);
  typed_message->~Port();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Port_message_member_array[3] = {
  {
    ...
    offsetof(camera_interface::msg::Port, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(camera_interface::msg::Port, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(camera_interface::msg::Port, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Port_message_members = {
  ...
  "Port",  // message name
  3,  // number of fields
  sizeof(camera_interface::msg::Port),
...
get_message_type_support_handle<camera_interface::msg::Port>()
{
  return &::camera_interface::msg::rosidl_typesupport_introspection_cpp::Port_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, camera_interface, msg, Port)() {
  return &::camera_interface::msg::rosidl_typesupport_introspection_cpp::Port_message_type_support_handle;
}
